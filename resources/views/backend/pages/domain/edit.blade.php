...
@section('fav_title', __('backend/domain.edit_domain') )
	...
	<div class="col-md-12">
		<div class="card">
			<div class="card-header">
				<div class="row">
					<div class="col-md-6"><h2><i class="{{ 'fa fa-pencil-square' }}"></i> {{ __('backend/domain.edit_domain') }}</h2></div>
			...
			<div class="card-body">
				...
				<form class="form-horizontal" action="{{ route('admin.domain.update',$row->id) }}" method="post" enctype="multipart/form-data">
					@csrf
					...
					<div class="form-group">
						<div class="col-md-6 mb-2 mx-auto">
							...
							<div>
								<input type="text" class="form-control" value="{{ $row->domain_name }}" name="domain_name" id="domain_name" required="">
							</div>
						</div>
						<div class="col-md-6 mb-2 mx-auto">
							<label for="source" class="label">Username <span class="text-danger">*</span></label>
							<div>
								<input type="text" class="form-control" value="{{ $row->d_username }}" name="d_username" id="d_username" required="">
							</div>
						</div>
						<div class="col-md-6 mb-2 mx-auto">
							<label for="amount" class="label">Password <span class="text-danger">*</span></label>
							<div>
								<input type="text" class="form-control" value="{{ $row->d_password }}" name="d_password" id="d_password" required="">
							</div>
