...
@section('fav_title', __('backend/database.add_database') )
	...
	<div class="col-md-12">
		<div class="card">
			<div class="card-header">
				<div class="row">
					<div class="col-md-6"><h2><i class="{{ 'fa fa-plus-square' }}"></i> {{ __('backend/database.add_database') }}</h2></div>
			...
			<div class="card-body">
				...
				<form class="form-horizontal" action="{{ route('admin.database.store') }}" method="post" enctype="multipart/form-data">
					@csrf
					...
					<div class="form-group">
						<div class="col-md-6 mb-2 mx-auto">
							...
							<div>
								...
								<select required="" class="form-control" name="domain_id" id="domain_name">
									...
									@foreach($rows as $row)
										<option value="{{ $row->id }}">{{ $row->domain_name }} (<span class="badge badge-secondary">{{ count($row->db) }}</span>)</option>
									@endforeach
								</select>
							</div>
						</div>
						...
						<div class="col-md-6 mb-2 mx-auto">
							...
							<div>
								<input type="text" class="form-control" name="username" id="d_username" required="">
							</div>
						</div>
						<div class="col-md-6 mb-2 mx-auto">
							<label for="amount" class="label">Password <span class="text-danger">*</span></label>
							<div>
								<input type="text" class="form-control" name="password" id="d_password" required="">
							</div>
