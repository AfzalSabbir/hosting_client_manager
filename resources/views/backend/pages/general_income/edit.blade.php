...
@section('fav_title', __('backend/general_income.edit_general_income') )
	...
	<div class="col-md-12">
		<div class="card">
			<div class="card-header">
				<div class="row">
					<div class="col-md-6"><h2><i class="{{ 'fa fa-pencil-square' }}"></i> {{ __('backend/general_income.edit_general_income') }}</h2></div>
					<div class="col-md-6"><a href="{{ route('admin.general_income.index') }}" class="float-right btn btn-primary"><i class="fa fa-arrow-left"></i> {{ __('backend/default.list') }}</a></div>
					<div class="clearfix"></div>
				</div>
			</div>
			<div class="card-body">
				@include('backend.partials.error_message')
				<form class="form-horizontal" action="{{ route('admin.general_income.update',$row->id) }}" method="post" enctype="multipart/form-data">
					@csrf
