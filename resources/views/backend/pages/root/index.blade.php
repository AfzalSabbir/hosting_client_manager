							...
							<div class="col-lg-8 form-group">
								...
								<div class="row">
									<div class="col-md-6 position-relative mt-5">
										...
										<select required name="fafaOfSideMenu" id="" class="fontawesome_ form-control fafaOfSideMenu"></select>
									</div>
									<div class="col-md-6 position-relative mt-5">
										...
										<select required name="fafaCardHeader" id="" class="fontawesome_ form-control fafaCardHeader"></select>
									</div>
								</div>
								<div class="row">
									<div class="col-md-6 position-relative mt-5">
...
@include('backend.partials.script_fontawesome')
