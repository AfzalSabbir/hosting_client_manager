<ul class="app-menu pb-0 bg-theme" style="border-bottom: 8px solid #007d71">
  <li class="treeview {{ (Route::is('admin.menu.index') || Route::is('admin.menu.create') || Route::is('admin.menu.sort') || Route::is('admin.menu.edit')) ? 'is-expanded' : '' }}"><a class="app-menu__item {{ (Route::is('admin.menu.index') || Route::is('admin.menu.create') || Route::is('admin.menu.edit')) ? 'active' : '' }}" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-laptop"></i><span class="app-menu__label">{{ __('backend/sidebar.menu') }}</span><i class="treeview-indicator fa fa-angle-right"></i></a>
