...
<div class="row">
	<div class="col-md-12">
		<div class="card">
			<div class="card-header">
				<div class="row">
					...
					<div class="col-md-6">
						...
						<a href="{{ route('admin.cost.index') }}" class="float-right btn btn-primary"><i class="fa fa-arrow-left"></i> {{ __('backend/default.list') }}</a>
					</div>
			...
			<div class="card-body">
				<form class="form-horizontal mt-4 alert-info pt-3 pb-5 br-4 border-info" id="add_source_container" action="{{ route('admin.cost.add_source') }}" method="post" enctype="multipart/form-data" style="display: none;">
					@csrf
					...
					<div class="form-group">
						<div class="col-md-6 mb-2 mx-auto">
							...
							<div>
								<input type="text" class="form-control" name="source" id="source" required="">
								<input type="hidden" class="form-control" name="source_type" value="2" id="source_type" required="">
							</div>
