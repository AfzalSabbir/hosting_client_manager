...
@section('fav_title', __('backend/payment.edit_payment') )
	...
	<div class="col-md-12">
		<div class="card">
			<div class="card-header">
				<div class="row">
					<div class="col-md-6"><h2><i class="{{ 'fa fa-pencil-square' }}"></i> {{ __('backend/payment.edit_payment') }}</h2></div>
			...
			<div class="card-body">
				...
				<form class="form-horizontal" action="{{-- route('admin.payment.update',$row->id) --}}" method="post" enctype="multipart/form-data">
					@csrf
