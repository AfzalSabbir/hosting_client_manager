...
@section('fav_title', __('backend/service_charge.view_service_charge') )
	...
	<div class="col-md-12">
		<div class="card">
			...
			<div class="card-header">
				<div class="row">
					<div class="col-md-6"><h2><i class="{{ 'fa fa-eye' }}"></i> {{ __('backend/service_charge.view_service_charge') }}</h2></div>
					{{-- <div class="col-md-6">
						<div class="btn-group float-right">
							<a href="{{ route('admin.service_charge.index') }}" class="btn btn-primary"><i class="fa fa-arrow-left"></i> {{ __('backend/default.list') }}</a><a href="{{ route('admin.service_charge.edit',$row->id) }}" class="btn btn-warning"><i class="fa fa-edit"></i> {{ __('backend/default.edit') }}</a>
						</div>
					</div> --}}
