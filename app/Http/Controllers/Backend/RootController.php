...
class RootController extends Controller
{
	...
	public function create(Request $request)
	{
		...
		**/
		...
		if (isset($request->fafaOfSideMenu)) {
			$fafaOfSideMenu = FontawesomeHelper::fontawesome($request->fafaOfSideMenu);
			$data['fafaOfSideMenu'] = $fafaOfSideMenu;
		}
		if (isset($request->fafaCardHeader)) {
			$fafaCardHeader = FontawesomeHelper::fontawesome($request->fafaCardHeader);
			$data['fafaCardHeader'] = $fafaCardHeader;
		}
